  ...
  const sendToN8n = useCallback(async (message: string) => {
    ...
    try {
      ...
      if (data.intent === "book_calendar") {
        // Immediate calendar popup for better UX
      ...
      // Re-enable sending after 800ms to prevent spam
      ...
      <div className="bg-white border-t border-gray-200 px-6 py-4">
        <form onSubmit={handleSubmit} className="flex items-center space-x-3">
          ...
          <button
            ...
            className={`w-12 h-12 rounded-full flex items-center justify-center focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all duration-200 shadow-lg ${
              isSending 
